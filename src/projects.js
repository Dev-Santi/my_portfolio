export default [
    {
        ...
        description:
            "Aplicación web que tiene como objetivo principal el facilitar una gestión eficiente de los plazos legales y administrativos en Uruguay.",
        img: "/card_imgs/justo_a_tiempo.png",
        alt: "Ilustración de cómo se ve el sitio web en una notebook.",
        tools: ["TypeScript", "Next.js", "Node.js", "Tailwind", "Vercel"],
